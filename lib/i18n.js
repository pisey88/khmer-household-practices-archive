...
export const TRANSLATIONS = {
  en: {
    ...
    navSignup: "Sign up",
    navLogout: "Log Out",
    navAuthUnavailable: "Auth unavailable",
    ...
    footerMission: "Documenting everyday knowledge, tools, and memories before modern appliances.",
    footerStatus: "System Active • Kampong Speu Collection",
    footerExplore: "Explore",
    footerArchiveCollection: "Archive Collection",
    footerCategories: "Categories",
    footerContribute: "Contribute",
    footerSubmitPractice: "Submit Practice",
    footerContributorGuide: "Contributor Guide",
    footerQuote: "Preserving the living memory of our elders, one practice at a time.",
    footerCopyright: "© 2026 Khmer Household Practices Archive. Community preserved.",
    footerNextJs: "Next.js 15",
    footerSupabase: "Supabase Auth",
  },
  ...
  km: {
    ...
    navSignup: "ចុះឈ្មោះ",
    navLogout: "ចាកចេញ",
    navAuthUnavailable: "ការផ្ទៀងផ្ទាត់មិនអាចប្រើបាន",
    profileMenuLabel: "បើកម៉ឺនុយគណនី",
    navMenuLabel: "បើកម៉ឺនុយរុករក",
    authBackHome: "← ត្រឡប់ទៅទំព័រដើម",
    ...
    footerMission: "កត់ត្រាចំណេះដឹងប្រចាំថ្ងៃ ឧបករណ៍ និងការចងចាំ មុនពេលមានគ្រឿងបរិក្ខារទំនើប។",
    footerStatus: "ប្រព័ន្ធដំណើរការ • បណ្ណសារខេត្តកំពង់ស្ពឺ",
    footerExplore: "ស្វែងរក",
    footerArchiveCollection: "បណ្ណសារ",
    footerCategories: "ប្រភេទ",
    footerContribute: "ចូលរួម",
    footerSubmitPractice: "ដាក់ស្នើទំនៀមទម្លាប់",
    footerContributorGuide: "មគ្គុទ្ទេសក៍អ្នកចូលរួម",
    footerQuote: "ថែរក្សាការចងចាំដ៏រស់របស់ចាស់ទុំ តាមរយៈទំនៀមទម្លាប់មួយម្ដងៗ។",
    footerCopyright: "© ២០២៦ បណ្ណសារទំនៀមទម្លាប់គ្រួសារខ្មែរ។ រក្សាទុកដោយសហគមន៍។",
    footerNextJs: "Next.js 15",
    footerSupabase: "Supabase Auth",
  },
};
